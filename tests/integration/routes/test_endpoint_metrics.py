...
def test_metrics_endpoint_returns_200(client, auth_headers):
    """
...
def test_metrics_endpoint_returns_prometheus_content_type(client, auth_headers):
    """
    GIVEN a running STAR application
    WHEN the /metrics endpoint is requested
...
def test_metrics_endpoint_returns_non_empty_body(client, auth_headers):
    """
    GIVEN a running STAR application
    WHEN the /metrics endpoint is requested
...
def test_metrics_payload_uses_prometheus_text_format(client, auth_headers):
    """
    GIVEN a running STAR application
    WHEN the /metrics endpoint is requested
