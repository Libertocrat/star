...
DEFAULT_STAR_MAX_BODY_BYTES="1048576"
...
DEFAULT_STAR_STORAGE_REPAIR_MIN_AGE_SECONDS="3600"
...
STAR_MAX_BODY_BYTES=${DEFAULT_STAR_MAX_BODY_BYTES}
...
# Offline managed-storage repair grace period
STAR_STORAGE_REPAIR_MIN_AGE_SECONDS=${DEFAULT_STAR_STORAGE_REPAIR_MIN_AGE_SECONDS}
