...
- Added typed rendered argv tokens and final pre-spawn verification that requires every mounted extension invocation to match its immutable build-time form, bounded value policy, and managed resource ownership before process creation.
