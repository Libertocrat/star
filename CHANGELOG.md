...
- Enforced provenance-authorized compiled invocation policy for both CORE and EXTENSION actions during registry construction, request-dependent validation, rendering, and final pre-spawn verification; extension capability controls remain additive.
...
- Required files and actions routes to resolve typed runtime dependencies from application state, surfacing invalid runtime state through stable STAR error envelopes.
...
- Made file deletion metadata-first and idempotent for valid records whose blobs are already missing.
...
[Unreleased]: https://github.com/Libertocrat/star/compare/v0.1.4...HEAD
[0.1.4]: https://github.com/Libertocrat/star/releases/tag/v0.1.4
